...
# Define PAN
class PAN_2R_fp(torch.nn.Module):
    def __init__(self, LayerNo):
        super(PAN_2R_fp, self).__init__()
        onelayer = []
...
# Define PAN plus
class PAN_2R_plus_fp(torch.nn.Module):
    def __init__(self, LayerNo):
        super(PAN_2R_plus_fp, self).__init__()
        onelayer = []
        self.LayerNo = LayerNo
...
# Define PAN-MRI
class PAN_MRI_2R_fp(torch.nn.Module):
    def __init__(self, LayerNo):
        super(PAN_MRI_2R_fp, self).__init__()
        onelayer = []
        self.LayerNo = LayerNo
...
# Define PAN-plus MRI
class PAN_MRI_2R_plus_fp(torch.nn.Module):
    def __init__(self, LayerNo):
        super(PAN_MRI_2R_plus_fp, self).__init__()
        onelayer = []
        self.LayerNo = LayerNo
        self.fft_forback = FFT_Mask_ForBack()
