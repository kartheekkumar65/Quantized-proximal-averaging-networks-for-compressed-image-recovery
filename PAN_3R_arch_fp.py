...
# Define PAN plus
class PAN_3R_plus(torch.nn.Module):
    def __init__(self, LayerNo):
        super(PAN_3R_plus, self).__init__()
        onelayer = []
        self.LayerNo = LayerNo
...
# Define PAN-MRI
class PAN_MRI_3R(torch.nn.Module):
    def __init__(self, LayerNo):
        super(PAN_MRI_3R, self).__init__()
        onelayer = []
        self.LayerNo = LayerNo
...
# Define PAN-plus MRI
class PAN_MRI_3R_plus(torch.nn.Module):
    def __init__(self, LayerNo):
        super(PAN_MRI_3R_plus, self).__init__()
        onelayer = []
        self.LayerNo = LayerNo
        self.fft_forback = FFT_Mask_ForBack()
